...
var animalsObject = {
  animals: ["Tiger" , "Lion" , "Zebra" , "Gorilla"],
  tigers: 2,
  lions: 4,
  zebras: 9,
  gorillas: 5
...
animalsObject.animals.push('Turtle');
animalsObject.turtles = 2;
console.log(animalsObject);

// Change the value for at least one of your animal keys, and log the updated Object.
animalsObject.turtles = 28;
console.log(animalsObject);

// Add another animal to the zoo Object, and log the updated Object.
animalsObject.animals.push('Peacock');
animalsObject.peacocks = 3;
console.log(animalsObject);
...
var emailAnatomy = {
  ...
  body: "Body of email",
  bodyCharLength: 500, //length in characters
  signature: "Signature of email"
}
console.log(emailAnatomy);
...
var workEmails = [
  {
    sender: "Lauren",
    subject: "Work schedule next week",
    body: "Here is your work schedule next week, please confirm",
    bodyCharLength: 60, //length in characters
